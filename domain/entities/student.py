...
class StudentInput(BaseModel):
    """
    Student model representing a user in the application with additional fields for input.
    """
...
class StudentOutput(StudentInput):
    """
    Student model representing a user in the application with additional fields for output.
    """
